            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="pwd" class="form-control" id="password_add_input" placeholder="****">
                            <span class="help-block"></span>
                        </div>
                    </div>
               </form>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">username</label>
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" id="username_modify_input" value="${user.username}" placeholder="username">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">password</label>
                        <div class="col-sm-10">
                            <input type="password" name="pwd" class="form-control" id="password_modify_input" value="${user.password}" placeholder="password">
                            <span class="help-block"></span>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    function build_users_table(result){
        ...
        $.each(users,function(index,user){
            ...
            var usernameTd = $("<td></td>").append(user.name);
            var passwordTd = $("<td></td>").append(user.pwd);
